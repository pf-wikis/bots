...
public enum AAPIQueryDeletedrevisionsProp {
	...
	public static class Builder {
		private EnumSet<AAPIQueryDeletedrevisionsProp> set =
				EnumSet.noneOf(AAPIQueryDeletedrevisionsProp.class);

		public AAPIQueryDeletedrevisionsProp[] build() {
			return set.toArray(AAPIQueryDeletedrevisionsProp[]::new);
		}
