...
public enum AAPIPurgeGenerator {
	...
	private final Class<? extends AAPIPurgeGeneratorModule> type;

	public static interface AAPIPurgeGeneratorModule extends AAPIModule {}

	public static class AAPIPurgeGeneratorSubmodule
			extends AAPISubmodule<AAPIPurgeGenerator, AAPIPurgeGeneratorModule> {
		public AAPIPurgeGeneratorSubmodule(AAPIPurgeGenerator k, AAPIPurgeGeneratorModule v) {
			super(k, v);
		}
	}

	public static AAPIPurgeGeneratorSubmodule createSubmodule(AAPIPurgeGeneratorModule module) {
		return new AAPIPurgeGeneratorSubmodule(
				switch (module) {
	...
	public static List<AAPIPurgeGeneratorSubmodule> createSubmodule(
			AAPIPurgeGeneratorModule... modules) {
		var result = new ArrayList<AAPIPurgeGeneratorSubmodule>();
		for (var v : modules) {
