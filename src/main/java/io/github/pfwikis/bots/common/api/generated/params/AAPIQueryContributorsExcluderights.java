...
public enum AAPIQueryContributorsExcluderights {
	...
	public static class Builder {
		private EnumSet<AAPIQueryContributorsExcluderights> set =
				EnumSet.noneOf(AAPIQueryContributorsExcluderights.class);

		public AAPIQueryContributorsExcluderights[] build() {
			return set.toArray(AAPIQueryContributorsExcluderights[]::new);
		}
