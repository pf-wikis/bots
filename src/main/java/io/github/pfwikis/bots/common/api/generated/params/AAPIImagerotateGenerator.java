...
public enum AAPIImagerotateGenerator {
	...
	private final Class<? extends AAPIImagerotateGeneratorModule> type;

	public static interface AAPIImagerotateGeneratorModule extends AAPIModule {}

	public static class AAPIImagerotateGeneratorSubmodule
			extends AAPISubmodule<AAPIImagerotateGenerator, AAPIImagerotateGeneratorModule> {
		public AAPIImagerotateGeneratorSubmodule(
				AAPIImagerotateGenerator k, AAPIImagerotateGeneratorModule v) {
			super(k, v);
		}
	}

	public static AAPIImagerotateGeneratorSubmodule createSubmodule(
			AAPIImagerotateGeneratorModule module) {
		return new AAPIImagerotateGeneratorSubmodule(
				switch (module) {
	...
	public static List<AAPIImagerotateGeneratorSubmodule> createSubmodule(
			AAPIImagerotateGeneratorModule... modules) {
		var result = new ArrayList<AAPIImagerotateGeneratorSubmodule>();
		for (var v : modules) {
