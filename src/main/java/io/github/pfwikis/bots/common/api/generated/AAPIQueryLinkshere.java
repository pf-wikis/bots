...
import io.github.pfwikis.bots.common.api.generated.params.AAPIQueryLinkshereProp;

import io.github.pfwikis.bots.common.api.generated.params.AAPIQueryLinkshereShow;
 ...
 */
public class AAPIQueryLinkshere
	...
	public static AAPIQueryLinkshere create() {

		AAPIQueryLinkshere v = new AAPIQueryLinkshere();

		return v;
	}

	private AAPIQueryLinkshere() {}

	private List<AAPIQueryLinkshereProp> prop;
	 ...
	 * <dl></dl>
	 */
	public List<AAPIQueryLinkshereProp> getProp() {
		return this.prop;
	}
	 ...
	 * <dl></dl>
	 */
	public List<AAPIQueryLinkshereShow> getShow() {
		return this.show;
	}
	...
	public String toString() {
		var sb = new StringBuilder().append("AAPIQueryLinkshere(");
		...
		if (limit != null) {
			...
			sb.append("lhlimit").append("=").append(limit.toString());
	...
	private class Builder extends AAPIModule.Builder {
		...
		public void forEachModule(Consumer<AAPIModule> c) {
			c.accept(AAPIQueryLinkshere.this);
		}

		@Override
		public <T> T mapReduce(Function<AAPIModule, T> map, BinaryOperator<T> reduce) {
			T value = map.apply(AAPIQueryLinkshere.this);
