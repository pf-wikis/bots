...
public enum AAPIQueryAlldeletedrevisionsProp {
	...
	/**Content of each revision slot. If the content has been revision deleted, a <samp>texthidden</samp> property will be returned. For performance reasons, if this option is used, <var>adrlimit</var> is enforced to 50.*/
	CONTENT("content"),
	...
	/**<span class="apihelp-deprecated">Deprecated.</span> Use <kbd><a href="/wiki/Special:ApiHelp/expandtemplates" title="Special:ApiHelp/expandtemplates">action=expandtemplates</a></kbd> or <kbd><a href="/wiki/Special:ApiHelp/parse" title="Special:ApiHelp/parse">action=parse</a></kbd> instead. The XML parse tree of revision content (requires content model <code>wikitext</code>). For performance reasons, if this option is used, <var>adrlimit</var> is enforced to 50.*/
	PARSETREE("parsetree");
	...
	public static class Builder {
		private EnumSet<AAPIQueryAlldeletedrevisionsProp> set =
				EnumSet.noneOf(AAPIQueryAlldeletedrevisionsProp.class);

		public AAPIQueryAlldeletedrevisionsProp[] build() {
			return set.toArray(AAPIQueryAlldeletedrevisionsProp[]::new);
		}
