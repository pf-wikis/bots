 ...
 */
public class AAPIResetpassword implements AAPIModule, AAPITokenModule, AAPIMainActionModule {

	public static AAPIResetpassword create() {

		AAPIResetpassword v = new AAPIResetpassword();

		return v;
	}

	private AAPIResetpassword() {}
	...
	public String toString() {
		var sb = new StringBuilder().append("AAPIResetpassword(");
	...
	private class Builder extends AAPIModule.Builder {
		...
		public void forEachModule(Consumer<AAPIModule> c) {
			c.accept(AAPIResetpassword.this);
		}

		@Override
		public <T> T mapReduce(Function<AAPIModule, T> map, BinaryOperator<T> reduce) {
			T value = map.apply(AAPIResetpassword.this);
