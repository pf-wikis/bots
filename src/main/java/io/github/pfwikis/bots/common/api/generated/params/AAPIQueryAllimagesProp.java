...
public enum AAPIQueryAllimagesProp {
	...
	public static class Builder {
		private EnumSet<AAPIQueryAllimagesProp> set = EnumSet.noneOf(AAPIQueryAllimagesProp.class);

		public AAPIQueryAllimagesProp[] build() {
			return set.toArray(AAPIQueryAllimagesProp[]::new);
		}
