...
public enum AAPIUserrightsRemove {
	...
	public static class Builder {
		private EnumSet<AAPIUserrightsRemove> set = EnumSet.noneOf(AAPIUserrightsRemove.class);

		public AAPIUserrightsRemove[] build() {
			return set.toArray(AAPIUserrightsRemove[]::new);
		}
