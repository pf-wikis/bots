...
public enum AAPITemplatedataGenerator {
	...
	private final Class<? extends AAPITemplatedataGeneratorModule> type;

	public static interface AAPITemplatedataGeneratorModule extends AAPIModule {}

	public static class AAPITemplatedataGeneratorSubmodule
			extends AAPISubmodule<AAPITemplatedataGenerator, AAPITemplatedataGeneratorModule> {
		public AAPITemplatedataGeneratorSubmodule(
				AAPITemplatedataGenerator k, AAPITemplatedataGeneratorModule v) {
			super(k, v);
		}
	}

	public static AAPITemplatedataGeneratorSubmodule createSubmodule(
			AAPITemplatedataGeneratorModule module) {
		return new AAPITemplatedataGeneratorSubmodule(
				switch (module) {
	...
	public static List<AAPITemplatedataGeneratorSubmodule> createSubmodule(
			AAPITemplatedataGeneratorModule... modules) {
		var result = new ArrayList<AAPITemplatedataGeneratorSubmodule>();
		for (var v : modules) {
