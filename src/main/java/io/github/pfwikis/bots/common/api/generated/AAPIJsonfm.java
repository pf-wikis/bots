...
import io.github.pfwikis.bots.common.api.generated.params.AAPIJsonfmFormatversion;

import io.github.pfwikis.bots.common.api.generated.params.AAPIMainFormat.AAPIMainFormatModule;

/** Output data in JSON format (pretty-print in HTML).
 */
public class AAPIJsonfm implements AAPIModule, AAPIMainFormatModule {

	public static AAPIJsonfm create() {

		AAPIJsonfm v = new AAPIJsonfm();
	...
	private AAPIJsonfmFormatversion formatversion;
	 ...
	 * <dl></dl>
	 */
	public AAPIJsonfmFormatversion getFormatversion() {
		return this.formatversion;
	}

	public String toString() {
		var sb = new StringBuilder().append("AAPIJsonfm(");
	...
	private class Builder extends AAPIModule.Builder {
		...
		public void forEachModule(Consumer<AAPIModule> c) {
			c.accept(AAPIJsonfm.this);
		}

		@Override
		public <T> T mapReduce(Function<AAPIModule, T> map, BinaryOperator<T> reduce) {
			T value = map.apply(AAPIJsonfm.this);
