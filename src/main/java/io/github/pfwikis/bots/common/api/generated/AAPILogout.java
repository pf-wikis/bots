 ...
 */
public class AAPILogout implements AAPIModule, AAPITokenModule, AAPIMainActionModule {

	public static AAPILogout create() {

		AAPILogout v = new AAPILogout();
	...
	public String toString() {
		var sb = new StringBuilder().append("AAPILogout(");
	...
	private class Builder extends AAPIModule.Builder {
		...
		public void forEachModule(Consumer<AAPIModule> c) {
			c.accept(AAPILogout.this);
		}

		@Override
		public <T> T mapReduce(Function<AAPIModule, T> map, BinaryOperator<T> reduce) {
			T value = map.apply(AAPILogout.this);
