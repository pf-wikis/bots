...
public enum AAPIQueryContributorsRights {
	...
	public static class Builder {
		private EnumSet<AAPIQueryContributorsRights> set =
				EnumSet.noneOf(AAPIQueryContributorsRights.class);

		public AAPIQueryContributorsRights[] build() {
			return set.toArray(AAPIQueryContributorsRights[]::new);
		}
