...
public enum AAPIWatchGenerator {
	...
	private final Class<? extends AAPIWatchGeneratorModule> type;

	public static interface AAPIWatchGeneratorModule extends AAPIModule {}

	public static class AAPIWatchGeneratorSubmodule
			extends AAPISubmodule<AAPIWatchGenerator, AAPIWatchGeneratorModule> {
		public AAPIWatchGeneratorSubmodule(AAPIWatchGenerator k, AAPIWatchGeneratorModule v) {
			super(k, v);
		}
	}

	public static AAPIWatchGeneratorSubmodule createSubmodule(AAPIWatchGeneratorModule module) {
		return new AAPIWatchGeneratorSubmodule(
				switch (module) {
	...
	public static List<AAPIWatchGeneratorSubmodule> createSubmodule(
			AAPIWatchGeneratorModule... modules) {
		var result = new ArrayList<AAPIWatchGeneratorSubmodule>();
		for (var v : modules) {
