...
public enum AAPIQueryAllusersGroup {
	BOT("bot"),
	...
	public static class Builder {
		private EnumSet<AAPIQueryAllusersGroup> set = EnumSet.noneOf(AAPIQueryAllusersGroup.class);

		public AAPIQueryAllusersGroup[] build() {
			return set.toArray(AAPIQueryAllusersGroup[]::new);
		}
