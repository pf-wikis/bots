...
public enum AAPIQueryWatchlistShow {
	...
	public static class Builder {
		private EnumSet<AAPIQueryWatchlistShow> set = EnumSet.noneOf(AAPIQueryWatchlistShow.class);

		public AAPIQueryWatchlistShow[] build() {
			return set.toArray(AAPIQueryWatchlistShow[]::new);
		}
