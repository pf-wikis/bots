...
public enum AAPISetnotificationtimestampGenerator {
	...
	private final Class<? extends AAPISetnotificationtimestampGeneratorModule> type;

	public static interface AAPISetnotificationtimestampGeneratorModule extends AAPIModule {}

	public static class AAPISetnotificationtimestampGeneratorSubmodule
			extends AAPISubmodule<
					AAPISetnotificationtimestampGenerator,
					AAPISetnotificationtimestampGeneratorModule> {
		public AAPISetnotificationtimestampGeneratorSubmodule(
				AAPISetnotificationtimestampGenerator k,
				AAPISetnotificationtimestampGeneratorModule v) {
			super(k, v);
		}
	}

	public static AAPISetnotificationtimestampGeneratorSubmodule createSubmodule(
			AAPISetnotificationtimestampGeneratorModule module) {
		return new AAPISetnotificationtimestampGeneratorSubmodule(
				switch (module) {
	...
	public static List<AAPISetnotificationtimestampGeneratorSubmodule> createSubmodule(
			AAPISetnotificationtimestampGeneratorModule... modules) {
		var result = new ArrayList<AAPISetnotificationtimestampGeneratorSubmodule>();
		for (var v : modules) {
