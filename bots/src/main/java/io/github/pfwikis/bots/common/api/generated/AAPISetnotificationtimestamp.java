...
public class AAPISetnotificationtimestamp
	...
	public void buildRequest(RequestContext ctx) {
		...
		if (entirewatchlist != null) {
			...
			ctx.addParameter("entirewatchlist", entirewatchlist.toString());
		}
		...
		if (torevid != null) {
			...
			ctx.addParameter("torevid", torevid.toString());
		}

		if (newerthanrevid != null) {

			ctx.addParameter("newerthanrevid", newerthanrevid.toString());
		}
